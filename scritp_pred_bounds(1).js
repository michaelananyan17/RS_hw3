...
async function trainModel() {
    try {
        ...
        // Define model architecture - SIMPLIFIED and EFFECTIVE
...
async function predictRating() {
    ...
    try {
        ...
        // ENFORCE BOUNDS - SIMPLE AND GUARANTEED TO WORK
        predictedRating = Math.max(1.00, Math.min(5.00, predictedRating));
